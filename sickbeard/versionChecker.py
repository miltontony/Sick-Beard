...
class GitUpdateManager(UpdateManager):
    ...
    def _check_github_for_update(self):
        ...
        # find newest commit
	logger.log(u"Checking updates on miltontony/Sick-Beard/" + self.branch);
        for curCommit in gh.commits('miltontony', 'Sick-Beard', self.branch):
    ...
    def set_newest_text(self):
        ...
        if self._newest_commit_hash:
            url = 'http://github.com/miltontony/Sick-Beard/compare/'+self._cur_commit_hash+'...'+self._newest_commit_hash
        else:
            url = 'http://github.com/miltontony/Sick-Beard/commits/'
...
class SourceUpdateManager(GitUpdateManager):
    ...
    def update(self):
        ...
        tar_download_url = 'https://github.com/miltontony/Sick-Beard/tarball/'+version.SICKBEARD_VERSION
        sb_update_dir = os.path.join(sickbeard.PROG_DIR, 'sb-update')
